...
import com.example.slabdesign.store.sd.std.oracle.jpo.HrSpecPK;
...
public class HrSpecService {
    ...
    public HrSpecEntity lookup(String cmpCd, String orgCd, String hrPlantCd, String productTypeCd) {
        HrSpecPK pk = new HrSpecPK(cmpCd, orgCd, hrPlantCd, productTypeCd);
