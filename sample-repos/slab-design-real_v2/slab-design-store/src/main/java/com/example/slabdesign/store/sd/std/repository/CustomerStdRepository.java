...
import com.example.slabdesign.store.sd.std.jpo.CustomerStdPK;
...
public interface CustomerStdRepository extends JpaRepository<CustomerStdJpo, CustomerStdPK> {
     ...
     */
    List<CustomerStdJpo> findByCmpCdAndOrgCdAndProductCdAndCustomerCdOrderByPriorityAsc(
        String cmpCd, String orgCd, String productCd, String customerCd
    );
}
