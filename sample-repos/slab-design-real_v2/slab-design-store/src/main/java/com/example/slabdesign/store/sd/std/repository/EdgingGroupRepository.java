...
import com.example.slabdesign.store.sd.std.jpo.EdgingGroupPK;
...
public interface EdgingGroupRepository extends JpaRepository<EdgingGroupJpo, EdgingGroupPK> {
     ...
     */
    List<EdgingGroupJpo> findByCmpCdAndOrgCdAndGradeCdAndProductCdAndCustomerCdAndHrTgtWidthLowLessThanEqualAndHrTgtWidthHighGreaterThanEqualOrderByPriorityAsc(
        String cmpCd, String orgCd, String gradeCd, String productCd, String customerCd,
