...
import com.example.slabdesign.store.sd.std.jpo.EdgingGroupJpo;
import com.example.slabdesign.store.sd.std.jpo.EdgingSpecJpo;
import com.example.slabdesign.store.sd.std.jpo.EdgingSpecPK;
import com.example.slabdesign.store.sd.std.repository.EdgingGroupRepository;
import com.example.slabdesign.store.sd.std.repository.EdgingSpecRepository;
...
public class EdgingService {
     ...
     *   GRADE_CD = ? AND PRODUCT_CD = ? AND CUSTOMER_CD = ?
    ...
    public EdgingGroupEntity findGroup(String cmpCd, String orgCd,
        ...
        List<EdgingGroupJpo> matches = groupRepository
            .findByCmpCdAndOrgCdAndGradeCdAndProductCdAndCustomerCdAndHrTgtWidthLowLessThanEqualAndHrTgtWidthHighGreaterThanEqualOrderByPriorityAsc(
                cmpCd, orgCd, gradeCd, productCd, customerCd, hrTgtWidth, hrTgtWidth);
