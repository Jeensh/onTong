 ...
 *
 * 두 진입점:
 *   - {@link #batchDesign(String, String)} — 회사·소 단위 배치 설계 (extractor 로 후보 수집).
 ...
 *   3. 결과 집계 (총/처리완료/skip + 처리된 슬랩 리스트)
 *
 * NOTE: @Transactional 미적용 — 배치 전체가 단일 tx 면 한 슬랩 fail 이 모두 rollback.
...
public class SdDriver {
    ...
    /**
     * 배치 결과 — 총 후보 수 / 처리 완료 / skip / 처리된 슬랩 리스트.
     */
