...
import com.example.slabdesign.store.sd.std.jpo.CustomerStdJpo;
import com.example.slabdesign.store.sd.std.repository.CustomerStdRepository;
...
public class CustomerStdService {
    ...
    public CustomerStdEntity findFirstMatch(String cmpCd, String orgCd,
                                            String productCd, String customerCd) {
        List<CustomerStdJpo> matches = repository
            .findByCmpCdAndOrgCdAndProductCdAndCustomerCdOrderByPriorityAsc(
                cmpCd, orgCd, productCd, customerCd);
