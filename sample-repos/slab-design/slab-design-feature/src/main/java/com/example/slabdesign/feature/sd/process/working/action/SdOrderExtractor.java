...
public class SdOrderExtractor {
    ...
    /**
     * 단일 PK 로 SDOrderEntity 추출 (admin/test-design 용).
     * findDesignable 의 진도/종결 필터를 우회 — 어떤 row 든 1건 통합 후 반환.
     */
    @Transactional(readOnly = true)
    public SDOrderEntity extractByPk(String cmpCd, String orgCd, String orderNo) {
